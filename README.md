...
| **AWS SDK** | boto3 |
| **Tests** | pytest — **<!--fact:tests-->642<!--/fact--> collected: <!--fact:tests_unit-->574<!--/fact--> unit + <!--fact:tests_integration-->68<!--/fact--> integration** (integration needs Docker or `$JOBFETCHER_DB_URL`; live-key tests skip without a key), live smoke, ~95% coverage in CI (85% floor) |
