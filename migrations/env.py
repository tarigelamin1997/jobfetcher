...
if config.config_file_name is not None:
    ...
    # already-imported logger not named in alembic.ini's [loggers] (root/sqlalchemy/alembic)
    # — silencing `jobfetcher.*` logging for the rest of the process whenever migrations run
    # programmatically (tests, in-process upgrades). Alembic's own docs recommend False for
    # exactly this embedded use.
