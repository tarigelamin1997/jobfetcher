...
- **Tests:** <!--fact:tests_unit-->489<!--/fact--> unit + <!--fact:tests_integration-->67<!--/fact--> integration (<!--fact:tests-->556<!--/fact--> collected; integration needs Docker or `$JOBFETCHER_DB_URL`), ~95% coverage in CI, `ruff` clean.
