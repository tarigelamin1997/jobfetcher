...
## Current status
**v0.6.0 SHIPPED (2026-07-06).** Since the v0 core (`v0.1.0`), the tool has grown through a **P2-driven burst of capability releases** — each next step re-derived from *real usage*, not the pre-drawn roadmap. Live-validated on the deployed stack throughout (Aurora scale-to-0 ⇒ ~$0 idle). Tests: **283 unit + 36 integration green**, `ruff` clean, CI green.
