...
- **Tests:** <!--fact:tests_unit-->598<!--/fact--> unit + <!--fact:tests_integration-->68<!--/fact--> integration (<!--fact:tests-->666<!--/fact--> collected; integration needs Docker or `$JOBFETCHER_DB_URL`), ~95% coverage in CI, `ruff` clean.
