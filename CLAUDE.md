...
- **Tests:** <!--fact:tests_unit-->499<!--/fact--> unit + <!--fact:tests_integration-->67<!--/fact--> integration (<!--fact:tests-->566<!--/fact--> collected; integration needs Docker or `$JOBFETCHER_DB_URL`), ~95% coverage in CI, `ruff` clean.
