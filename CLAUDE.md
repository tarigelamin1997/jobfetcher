...
- **Tests:** <!--fact:tests_unit-->482<!--/fact--> unit + <!--fact:tests_integration-->67<!--/fact--> integration (<!--fact:tests-->549<!--/fact--> collected; integration needs Docker or `$JOBFETCHER_DB_URL`), ~95% coverage in CI, `ruff` clean.
