...
| Semver: **minor `v0.x.0` per migration; patch `v0.x.y` for small fixes between migrations**; v1.0.0 at M8 → v1.x/v2.0 | Clean evolution story; a bug fix / tiny wiring doesn't need a whole minor bump | roadmap |
