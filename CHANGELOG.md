...
*Next up (in flight): v0.8.0 "the digest tells the truth" — digest scoping + graduation badges + duplicate collapse (PR #26, first auto-pilot unit). Then scorer integrity (subscore decomposition, approved) and ops hardening.*
